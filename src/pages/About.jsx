...
export default function About() {
  return (
    <>
      <SEO
        title="About CalcioCalc — Free Business Calculator Platform"
      ...
      <section className="container-page py-12 lg:py-16">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="panel p-6">
            <Calculator className="text-accent" size={26} />
      ...
      <section className="container-page py-12 lg:py-16">
        ...
        <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          <Link to="/calculators/ai" className="panel group block p-5 transition hover:-translate-y-1 hover:border-accent">
            ...
            <span className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-accent">Explore <ArrowRight size={16} className="transition group-hover:translate-x-1" /></span>
          </Link>
          <Link to="/calculators/startup" className="panel group block p-5 transition hover:-translate-y-1 hover:border-accent">
          ...
          <Link to="/calculators/marketing" className="panel group block p-5 transition hover:-translate-y-1 hover:border-accent">
          ...
          <Link to="/blog" className="panel group block p-5 transition hover:-translate-y-1 hover:border-accent">
      ...
      <section className="container-page py-12 lg:py-16">
        ...
        <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {calculators.slice(0, 6).map((item) => (
            <Link key={item.slug} to={`/calculator/${item.slug}`} className="panel group block p-5 transition hover:-translate-y-1 hover:border-accent">
              <p className="eyebrow">{item.category || "Calculator"}</p>
              <p className="mt-2 text-xl font-bold text-white">{item.title}</p>
              <p className="mt-3 text-sm leading-6 text-slate-400">{item.description}</p>
              <span className="mt-4 inline-flex items-center gap-2 text-sm font-bold text-accent">Open <ArrowRight size={16} className="transition group-hover:translate-x-1" /></span>
            </Link>
          ))}
        </div>
      </section>
