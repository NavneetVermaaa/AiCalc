...
export default function Disclaimer() {
  return (
    <>
      <SEO title="Disclaimer — Accuracy & Legal Information — CalcioCalc" description={`${BRAND.name} disclaimer. Our calculators provide estimates for informational and educational purposes only. Verify critical numbers with a qualified professional.`} path="/disclaimer" schema={[disclaimerSchema]} />
