...
export default function SearchPage() {
  ...
  return (
    <>
      <SEO title="Search Free Calculators & Business Guides — CalcioCalc" description="Search 60+ free business calculators and 20+ in-depth guides on AI costs, startup metrics, marketing ROI, and finance." path="/search" noindex />
