...
export default function SearchPage() {
  ...
  return (
    <>
      <SEO title="Search Calculators & Guides — CalcioCalc" description="Search 60+ free business calculators and 20+ in-depth guides on AI costs, startup metrics, marketing ROI, and finance." path="/search" noindex />
