...
export default function CookiePolicy() {
  return (
    <>
      <SEO title="Cookie Policy — Cookies Used on CalcioCalc" description={`${BRAND.name} cookie policy. Learn about the cookies we use and how to control your preferences when using our free calculators.`} path="/cookie-policy" schema={[cookieSchema]} />
