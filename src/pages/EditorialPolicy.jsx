...
export default function EditorialPolicy() {
  return (
    <>
      <SEO title="Editorial Policy | How CalcioCalc Creates Content" description={`${BRAND.name} editorial policy. Transparency in how our calculator formulas and content are created, reviewed, and updated.`} path="/editorial-policy" schema={[editorialSchema]} />
