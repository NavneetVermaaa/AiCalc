...
export default function EditorialPolicy() {
  return (
    <>
      <SEO title="Editorial Policy — How CalcioCalc Creates Content" description={`${BRAND.name} editorial policy. Learn how our calculator formulas and guides are created, fact-checked, reviewed, and updated to ensure accuracy.`} path="/editorial-policy" schema={[editorialSchema]} />
