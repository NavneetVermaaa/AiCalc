...
export default function BlogListPage() {
  ...
  return (
    <>
      <SEO title="CalcioCalc Blog — AI, SaaS, Startup & Marketing Guides" description="Read in-depth guides on AI API pricing, SaaS startup metrics, marketing ROI calculations, and financial benchmarks. Free calculators included with every article." path="/blog" schema={[blogSchema]} />
