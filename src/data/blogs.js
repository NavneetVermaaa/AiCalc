...
const article1 = {
  ...
  sections: [
    ...
    { type: "cta", slug: "cac-calculator", title: "Calculate Your CAC Instantly", description: "Use our free CAC Calculator to compute your customer acquisition costs, benchmark against industry standards, and identify opportunities to reduce spend." },
...
const article4 = {
  ...
  body: [
    ...
    "Explore our Startup Metrics blog for more detailed guides on calculating and improving your SaaS metrics, or use the calculators below to benchmark your own numbers against the ranges covered in this guide."
  ]
};
...
const article5 = {
  ...
  body: [
    ...
    "Burn rate benchmarks vary by startup stage. Seed-stage companies typically have a net burn between $30,000 and $80,000 per month depending on team size and location. Pre-seed startups often run even leaner, with net burn under $25,000 per month as they focus on product-market fit before scaling the team or go-to-market operations. Series A companies average $80,000 to $200,000 per month as they scale the team and invest in go-to-market execution across multiple channels and customer segments. Growth-stage companies above $2M ARR can have net burn of $200,000 to $500,000 or more, but their revenue base offsets a larger portion of expenses and their unit economics are more established and predictable.",
...
const article8 = {
  ...
  sections: [
    ...
    { type: "text", content: "CloudCanvas, a B2B SaaS company with $120,000 MRR, reports $18,000 in new MRR from 30 new accounts, $7,000 in expansion MRR from existing customers who added seats, $9,000 in churned MRR from 12 accounts that canceled, and $3,000 in contraction MRR from 8 accounts that downgraded. The Quick Ratio is $25,000 divided by $12,000, or 2.08. This is in the healthy range but trending down from 3.1 the previous quarter. The CEO investigates and finds that a pricing change introduced three months ago triggered a wave of downgrades and cancellations among mid-tier customers. The fix is not to acquire more customers but to address the pricing friction and implement a retention campaign for the affected segment. Without the Quick Ratio trend, the CEO might have celebrated the $18,000 in new MRR and missed the erosion underneath." },
    {
      ...
      description: "Calculate your SaaS Quick Ratio instantly. Enter your new MRR, expansion MRR, churned MRR, and contraction MRR to measure growth efficiency and benchmark against industry standards."
    },
...
const article10 = {
  ...
  sections: [
    ...
    { type: "cta", slug: "cac-calculator", title: "Start Measuring Your SaaS Metrics", description: "Use our free CAC Calculator, LTV Calculator, Churn Rate Calculator, and MRR tools to measure your own metrics and benchmark them against industry standards. Every calculator includes clear formulas and actionable insights." },
