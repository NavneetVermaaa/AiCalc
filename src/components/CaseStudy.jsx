export default function CaseStudy({ company, situation, numbers, decision, outcome, lesson }) {
  return (
    <div className="panel mt-6 p-5">
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-mint">Case Study</p>
      ...
      <div className="mt-4 grid gap-4 text-sm leading-6 text-slate-300">
        ...
        <div className="rounded-lg border border-mint/20 bg-mint/5 p-3">
          <p className="text-xs font-semibold uppercase tracking-wider text-mint">Lesson</p>
