...
export default function CalculatorCTA({ slug, title, description }) {
  return (
    <div className="relative mt-10 overflow-hidden rounded-lg border border-accent/20 bg-gradient-to-b from-panel to-ink/80 p-8 text-center sm:p-10">
      <div className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-accent/60 to-transparent" />
      <p className="text-xs font-semibold uppercase tracking-[0.18em] text-accent">Free Calculator</p>
